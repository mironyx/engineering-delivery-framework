...
- **Re-read the project's vision / north-star doc** if one exists (e.g. a marketing article, pitch deck, founder essay, or product brief — wherever the project's "why this exists" is captured). Ask: what would make the product more *convincing* against that vision? What would a skeptical reader want to see that we haven't built yet?
