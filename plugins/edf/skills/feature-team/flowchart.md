...
flowchart TD
    ...
    S9 --> DONE(["fa:fa-check Team complete"])
    ...
    class S0,S1_N,S1_DIRECT,S1_EPIC,S1_EPIC_TASKS,S1_WAVES_TABLE,S1_WAVES_DAG,S1_WAVES_NONE,S1_EPIC_BOARD,S1_READ,S2,S3,WAVE_ENTRY,S4_PRE,S4B_NOTE,S5,S6,S6_GATE,S6_WAIT,S6_FWD,S6_TEAM_DONE,S6_SHUTDOWN,S7,S7_CLOSE,S8 process
